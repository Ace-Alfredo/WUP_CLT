...
```
  The previous graph hows that the closer the mean is to 50 the standard deviation decreases which is what the CL theory is based on. since the 41.83 standard deviation was divided by square root of 9(this is the sample size) it equals almost 13.95, closely enough to 14. but the graph is getting more and more symmetrical.
...
now using the square root of 16 for this graph we can now see it becoming more and more symmetrical. This is because of the more opinion discrepancies.   
...
The square root is now 25 and still at 25 the standard deviation starts to decrease since it is a larger number. but also gives more chance of discrepancies. 
...
The graph looks more symmetrical since the square root is 36 which always makes it have more opinion discrepancies. Every time the number get larger and larger the standard deviation is decreasing. Which now this all proves that the central limited theory, the more sample size we have, the lower the standard deviation will be.

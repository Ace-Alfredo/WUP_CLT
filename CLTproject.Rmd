...
```
  The previous graph hows that the closer the mean is to 50 the standard deviation decreases which is what the CL theory is based on. since the 41.83 standard deviation was divided by square root of 9(this is the sample size) it equals almost 13.9, closely enough to 14. but the graph is getting more and more symmetrical.
...
The graph looks more symmetrical since the square root is 36 which always makes it have more opinion discrepancies. Everytime the number get larger and larger the standard deviation is decreasing. Which now this all proves that the central limited theory  
